...
Подробно я обо всех рассказывать не буду, разве что коснусь комбинаторов. Однако
все инструменты и библиотеки детально расписаны в недавней статье
[Parsing In C#: Tools And Libraries](https://tomassetti.me/parsing-in-csharp).

<!-- Добавить что-нибудь про Nitra -->
...
<!-- TODO: описать или удалить секцию -->
