...
<table>
  <tr>
    ...
    <td>Напомню, что <b><a href="https://ru.wikipedia.org/wiki/Git">Git</a></b> -
      одна из самых популярных систем контроля версий. Она мощная: в ней можно
      фиксировать изменения (commit), создавать и сливать ветви (checkout и merge),
      сравнивать разные версии файлов (diff), вычислять авторов конкретных строк (blame),
      а также делать многие другие вещи.
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td><b><a href="https://ru.wikipedia.org/wiki/GEDCOM">GEDCOM</a></b> -
        формат описания генеалогических древ. Довольно старый,
...
на вкладке `Insights` отображается список людей в порядке уменьшения числа коммитов.
...
их правильно - можно заглянуть в репозиторий и убедиться в этом. Вот как выглядит
...
но пока что не знаю, как это лучше сделать.
