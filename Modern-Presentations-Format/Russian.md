...
В настоящее время, когда вовсю продвигаются шлемы виртуальной реальности и
...
<table>
  <tr>
    ...
    <td>Нестрашно, если внезапно пропадет доступ к интернету. Однако браузер
...
Во время презентации можно нажать на **S** и посмотреть на заготовленные тезисы,
речь и следующий слайд. Также доступен таймер, по которому можно замерить
...
Можно использовать для ассоциации слайдов с визуальными образами. К сожалению,
