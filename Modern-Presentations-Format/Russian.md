...
В настоящее время, когда во всю продвигаются шлемы виртуальной реалности,
...
характеристиками должны обладать современные презентации как с точки зрения
контента, так и с точки зрения оформления. Разумеется мое мнение субъективно и
не является истиной в последней инстанции.

В качестве демонстрации материала, доступны [примеры слайдов](https://kvanttt.github.io/Presentations/2018-05-15-Source-code-analyzers-how-generalizable-are-they/English/index.html#/) и [видео](https://www.youtube.com/watch?v=SSaymBqOwWs).

<cut>

Эволюция презентаций, мои метания, доступны в репозитории
...
целые абзацы в слайды, как будто это какая-то статья. Рассказывайте. А при
необходимости напишите статью, в которой будут разъяснены подробности.

### Использование метафор

Метафоры - это хорошо. Аудиторию нужно завлечь с самого начала, пробудить.
Это можно сделать с помощью смешных картинок, но главное знать меру.
...
Презентация доступна в виде сайта, открывается в браузере. Таким образом, не
страшна потеря флешки, поломка компа и другие невзгоды.

### Офлайн функционирование

<table>
  <tr>
    <td><img src=Offline.png width=200></td>
...
<table>
  <tr>
    <td><img src=Crossplatform.png ></td>
    <td>Работает на <b>Win</b>, <b>Mac</b>, <b>Linux</b>, <b>Android</b>, <b>iOS</b> Да, реально, можно
листать ее хоть на телефоне прямо во время демонстрации!</td>
  </tr>
</table>
...
<table>
  <tr>
    <td><img src=En.svg width=240></td>
...
<table>
  <tr>
    <td><img src=Link.svg width=240></td>
    <td>Любой желающий может открыть презентацию на своем устройстве прямо во
    время доклада. На титульном слайде короткая ссылка
...
<table border=0>
  <tr>
    <td><a href="https://ru.wikipedia.org/wiki/Git" ><img src="Git.svg" align=left width=100></a></td>
    <td>
      <ul>
...
В GitHub можно настроить так, чтобы при пуше в ветку `gh-pages` или
...
<table border=0>
  <tr>
    <td><a href="https://ru.wikipedia.org/wiki/Markdown" ><img src="Markdown.svg" align=left width=140 /></a>
    </td>
    <td>
      <ul>
        <li>Это простой формат, «Python» для технических писателей</li>
        <li>Технические писатели также могут вычитывать текст с помощью механизма <b>Pull Request | Merge Request</b> или просто коммитить в нужную ветвь, обычно master</li>
      </ul>
    </td>
  </tr>
</table>
...
Это обычный [текст](https://raw.githubusercontent.com/KvanTTT/Presentations/master/2018-05-15-Source-code-analyzers-how-generalizable-are-they/English.md).
